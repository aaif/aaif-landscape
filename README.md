...
The [AAIF](https://aaif.io) Agentic AI [Landscape](https://landscape.aaif.io) is intended to provide a view into the overall agentic AI landscape including AAIF members and projects. We categorize many of the most prominent open source software and open standards projects in agentic AI.
...
* We do not include closed source products and services or proprietary standards.  Closed source products that implement open source solutions are also not included.
